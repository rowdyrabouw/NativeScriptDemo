...
* `tkDrawerContent` - part of the RadSideDrawer, it holds a custom component `SideDrawer` that displays the contents of the drawer.
...
* `/shared/sidedrawer` - holds the contents of the drawer that are reused on every page. There is a StackLayout for the profile info on top and a ListView for showing the navigation items. Expand this custom component to match what you want to have in your drawer.
